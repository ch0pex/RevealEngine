function(add_engine_utest test_name test_src)
  list(APPEND TEST_FLAGS "--duration=true --output-on-failure=true")

  if (NOT TARGET engine-tests)
    add_custom_target(engine-tests)
  endif()

  set(test_exe_name "engine_test_${test_name}")
  ...
  add_dependencies(engine-tests ${test_exe_name})
endfunction()
