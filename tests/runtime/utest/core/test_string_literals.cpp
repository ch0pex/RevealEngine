...
#include "core/misc/string_literals.hpp"
...
DOCTEST_TEST_CASE("Relative path") {
  DOCTEST_CHECK_EQ(
      std::filesystem::path(rflect3d::absolute("../assets/models/car_2millions.obj")).filename(),
  ...
  DOCTEST_CHECK_EQ(
      std::filesystem::path(rflect3d::absolute("../assets/models/car.obj")).filename(),
...
DOCTEST_TEST_CASE("Relative path as string literal") {
  ...
  DOCTEST_CHECK_EQ(rflect3d::absolute(""), ""_abs);
  DOCTEST_CHECK_EQ(rflect3d::absolute("../assets/models/car_2millions.obj"), "../assets/models/car_2millions.obj"_abs);
}
